...
public class EncounterActivity extends AppCompatActivity {
    ...
    public void onClickSaveButton(View view) {
        ...
        if(dateVisit != null) {
            ...
            if(id != 0 ) {
                ...
                //Update last refill setting to COMMUNITY
                new PatientDAO(this).updateRefillSetting(facilityId, patientId);
    ...
    public void savePreferences() {
        ...
        editor.putString("question8", question8);
        editor.putString("question9", question9);
    ...
    public void restorePreferences() {
        ...
        question3 = preferences.getString("question3", "");
        question4 = preferences.getString("question4", "");
        ...
        notes = preferences.getString("notes", "");
        ...
        Spinner spinner = (Spinner) findViewById(R.id.question1);
        spinner.setSelection(SpinnerUtil.getIndex(spinner, question1));
        spinner = (Spinner) findViewById(R.id.question2);
        spinner.setSelection(SpinnerUtil.getIndex(spinner, question2));
        spinner = (Spinner) findViewById(R.id.question3);
        spinner.setSelection(SpinnerUtil.getIndex(spinner, question3));
        spinner = (Spinner) findViewById(R.id.question4);
        spinner.setSelection(SpinnerUtil.getIndex(spinner, question4));
        spinner = (Spinner) findViewById(R.id.question5);
    ...
    private void extractViewData() {
        ...
        question1 = String.valueOf(((Spinner) findViewById(R.id.question1)).getSelectedItem());
        question2 = String.valueOf(((Spinner) findViewById(R.id.question2)).getSelectedItem());
        question3 = String.valueOf(((Spinner) findViewById(R.id.question3)).getSelectedItem());
        question4 = String.valueOf(((Spinner) findViewById(R.id.question4)).getSelectedItem());
